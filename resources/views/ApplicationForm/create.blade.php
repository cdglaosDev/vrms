  ...
  <div class="panel panel-inverse">
    ...
    <div class="panel-body">
       <form  action="{{route('application-form.store')}}"  method="POST">
			...
			<li class="active">
            <a  href="#2a" data-toggle="tab">Vehicle</a>
			</li>
			<li><a href="#1a" data-toggle="tab">Application detail</a>
			</li>
			...
			<div class="tab-content mb-3 clearfix">
              ...
              <table  class="table table-bordered bg-default text-white" style="width:100%">
                    ...
                    <tr>
                        <td> <input type="text" class="form-control" id="validationCustom01" value="" placeholder="" name="division_no" required="">
                </td>
                        <td> <input type="text" class="form-control" id="validationCustom01" value="" placeholder="" name="division_no" required="">
                </td>
                        <td><input type="text" name="staff" requried></td>
                        <td></td>
