...
@page {size:A5 landscape ; margin:5px 0px 0px 5px;}
#print-paper input{
  font-size: 18px;
}
        ...
        <div class="row mb-2">
          ...
          <!--counter list start -->
            <div class="col-md-8 user_counter">
              ...
              data-id="{{ $value->service_counter_id }}" data-cname="{{ $value->service_counter_name }}" id="btn_counter{{$value->service_counter_id}}" onclick="clickBtn(this)" > 
    ...
    <!-- end second row -->
        <form  id="price-list" action="" method="POST"> 
          ...
          <div class="form-inline mt-3">
            ...
            <input type="text" class="form-control col-md-4 col-sm-4 "  placeholder=""  id="customer_name" name="user_payer" value="{{$app_form->customer_name ?? ''}}" @isset($app_form){{$app_form->customer_name ?'readonly="readonly"':''}}@endif>
...
<!-- start print page -->
<div id="print-paper" style="background-size: cover;background-position: left;background-repeat: no-repeat;width:1120px; height: 770px;">
  <div class="row">
  <div style="height: 160px;width:100%;">&nbsp;</div>
      <div class="row" style="height: 83px;padding-top:26px;width:100%;">
        <div style="width: 13%;" >&nbsp;</div>
        <div id="printBill" style="text-align: right;width: 17%;padding-left: 4px;"> 
          <input type="text" class="form-control mb-1 mr-sm-1 border-0 font-weight-bold"   placeholder=""  name="print_price_receipt_no" value="">
        </div>
        <div style="width: 6%;" >&nbsp;</div>
        <div id="printDate" style="width: 27%;"> 
          <input type="text" class="form-control border-0 font-weight-bold" id="issue_date" value="" name="date">
        </div>
        <div id="printAppNo" style="text-align:right;width: 19%;"> 
          <input type="text"  name="app_no" value=""  class="form-control border-0 font-weight-bold " style="font-family:'Saysettha OT' !important;">
        </div>
        <div id="printAppDate" style="text-align:right;width: 14%;padding-left:19px;"> 
          <input type="text" id="print_app_date"  name="ref_date" value=""  class="price-print-date form-control border-0 font-weight-bold "> 
        </div>
      </div>

      <div class="row" style="height:60px;  width: 100%;">
        <div style="width: 240px;">&nbsp;</div>
        <div id="printCustomer" style="width:70%; padding-top: 26px;">
          <input type="text" class="form-control border-0 font-weight-bold" id="" placeholder="" name="print_user_payer" value="" style="font-family:'Saysettha OT' !important; ">
        </div>
      </div>

      <div class="row" style="height:80px;width: 100%;">&nbsp;</div>
      <div class="row" style="height:290px;width: 100%; margin-top:10px;padding-left: 40px;padding-top:11px;">
          <div id="printList"></div>
      </div>
      <div class="row" style="height:20px;width: 100%;">&nbsp;</div>
    <div id="buy_lic_no" style="padding: 20px;margin-left: 150px;margin-top: -125px;color: #007bff;font-weight: 600;font-size:50px;width: 250px;"></div>
    
    <div class="row" style="height:40px;width: 100%; ">
        <div style="width: 15%;">&nbsp;</div>
        <div style="width: 21%;padding-top: 20px"><span style="font-size: 18px;font-family:'Saysettha OT' !important; margin-top: 20px" class="updated_by"></span></div>
        <div style="width: 37%;">&nbsp;</div>
        <div id="printTotal"  style="width:18%;padding-top: 20px;"> <input type="text" class="form-control border-0" id="total_amt" name="total_amt" placeholder="" value="{{ $total_amt ?? ''}}" style="text-align: right;"> </div>
        <div  style="width:5%;padding-top: 25px;font-family:'Saysettha OT' !important;font-size:16px;">{{"ກີບ"}}</div>
    </div>
...
<script>
  ...
  function myFunction() {      
      ...
      var counter_id = $(".active-counter").data('cname');
