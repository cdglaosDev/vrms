...
<div class="modal-body pt-0">
   <div class="tab-content clearfix">
      <div class="tab-pane active" id="appForm">
         ...
         <div class="row pt-4 pl-3">
            <a href="{{route('import-vehicle.index')}}" class="btn btn-secondary btn-sm mr-3" type="submit">{{ trans('button.back') }}</a> &nbsp; 
            @can('Importer-Application-Item-Entry-Print')
            ...
            @if($vehicle->regapps['app_status_id'] == 4  || $vehicle->regapps['app_status_id'] == 5|| $vehicle->regapps['app_status_id'] ==6)
               <a class="btn btn-secondary btn-sm disabled">{{ trans('button.approve') }}</a>
            @else
               <a class="btn btn-primary btn-sm approve" data-id="{{ $vehicle->regapps['id']}}">{{ trans('button.approve') }}</a>
            @endif
            <a href="" class=" {{$vehicle->regapps['app_status_id'] ==4 || $vehicle->regapps['app_status_id'] ==5 || $vehicle->regapps['app_status_id'] == 6?'btn btn-secondary btn-sm reject-detail disabled':'btn btn-danger btn-sm reject-detail'}} mr-3"  data-toggle="modal" data-target="#RejectModelDetail" data-app_status_id = "{{$vehicle->regapps['app_status_id']}}" data-id="{{$vehicle->regapps['id']}}">{{ trans('button.reject') }}</a>
            @endcan
            @can('Importer-Application-Item-Entry-Edit')
            <a class="text-white btn btn-info btn-sm edit_app {{$vehicle->regapps['app_status_id'] ==4 || $vehicle->regapps['app_status_id'] ==5 || $vehicle->regapps['app_status_id'] ==3?'text-white btn btn-secondary btn-sm disabled':'text-white btn btn-info btn-sm edit'}} mr-3"
   ...
   <div class="tab-pane" id="docDetail">
      <form  action="{{url('attach-document',  $vehicle->id)}}" id="myForm" method="POST" enctype="multipart/form-data">
         @csrf
            ...
            <tbody>
               <tr class="attach_doc">
                  ...
                  <td>
                     ...
                     @endif
                     @endcan
                     <a href="{{asset('images/doc/'.$vehicle->regapps['regapp_number'].'/'.$app_doc[2])}}" class="btn btn-primary btn-sm" target="_blank">{{ trans('button.view')}}</a>
                     @endif
                     @endif
                  </td>
               </tr>
               <tr class="attach_doc">
                  ...
                  <td>  
                     ...
                     @endcan
                     @endif
                     <a href="{{asset('images/doc/'.$vehicle->regapps['regapp_number'].'/'.$app_doc[5])}}" class="btn btn-primary btn-sm" target="_blank">{{ trans('button.view')}}</a>
                     @endif
                     @endif
                  </td>
               </tr>
               <tr class="attach_doc">
                  ...
                  <td>  
                     ...
                     @endcan
                     @endif
                     <a href="{{asset('images/doc/'.$vehicle->regapps['regapp_number'].'/'.$app_doc[4])}}" class="btn btn-primary btn-sm" target="_blank">{{ trans('button.view')}}</a>
                     @endif
                     @endif
                  </td>
               </tr>
               <tr class="attach_doc">
                  ...
                  <td> 
                     ...
                     @endcan
                     @endif
                     <a href="{{asset('images/doc/'.$vehicle->regapps['regapp_number'].'/'.$app_doc[3])}}" class="btn btn-primary btn-sm" target="_blank">{{ trans('button.view')}}</a>
                     @endif
                     @endif
                  </td>
               </tr>
               <tr class="attach_doc">
                  ...
                  <td>  
                     ...
                     @endcan
                     @endif
                     <a href="{{asset('images/doc/'.$vehicle->regapps['regapp_number'].'/'.$app_doc[6])}}" class="btn btn-primary btn-sm" target="_blank">{{ trans('button.view')}}</a>
                     @endif
                     @endif
                  </td>
               </tr>
               <tr class="attach_doc">
                  ...
                  <td> 
                     ...
                     @endcan
                     @endif
                     <a href="{{asset('images/doc/'.$vehicle->regapps['regapp_number'].'/'.$app_doc[7])}}" class="btn btn-primary btn-sm" target="_blank">{{ trans('button.view')}}</a>
                     @endif
                     @endif
                  </td>
               </tr>
               <tr class="attach_doc">
                  ...
                  <td>
                     ...
                     @endcan
                     @endif
                     <a href="{{asset('images/doc/'.$vehicle->regapps['regapp_number'].'/'.$app_doc[8])}}" class="btn btn-primary btn-sm" target="_blank">{{ trans('button.view')}}</a>
                     @endif
                     @endif
                  </td>
               </tr>
         ...
         <div class="row  pt-4">
            <div class="col-md-6 text-left">
               <a href="{{ url('/import-vehicle') }}" class="btn btn-secondary btn-sm ">{{ trans('button.back')}}</a>
            </div>
...
<!-- end print area -->
<!-- edit app form modal -->
@component('component.staff.editform',['vehicle'=>$vehicle])
@endcomponent
<!-- end edit app form modal -->

@include('Module5.importvehicle.editDocFile')
<div class="modal fade" id="RejectModelDetail" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="" method="POST"  id="reject_detail_form" name="reject">
                @method('POST')
               @csrf
...
<script type="text/javascript">
   var pre_app = "{{ url('/app-form-update') }}"
   var reject_url = "{{url('reject-app')}}";
   var edit_doc = "{{url('edit-document')}}";
         //update app form
         $(document).on("click", '.edit_app', function (e) {  
           ...
           document.getElementById("editAppForm").action = pre_app+"/"+$(this).data('id');
       });
     ...
     //reject app form
       $(document).on("click", '.reject-detail', function (e) { 
      
           document.getElementById("reject_detail_form").action = reject_url+"/"+$(this).data('id');
       });
