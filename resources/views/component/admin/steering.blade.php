<div class="modal fade" id="addModel1" tabindex="-1" role="modal-dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <form action="{{route('steering.store')}}" method="POST" id="addform">
        @method('post')
        @csrf
        <input type="hidden" id="new-id" value="">
        <div class="modal-header">
          <div class="col-md-11 text-center">
            <h3 class="text-center">{{trans('table.steering')}}</h3>
          </div>
        ...
        <div class="modal-body">
          <div class="form-row">
            <div class="col-md-12 mb-3">
              ...
              <input type="text" class="form-control name" value="" placeholder="Enter Steering Name" name="name" required="" title="{{trans('table_man.steering_msg_name')}}">
            </div>
            <div class="col-md-12 mb-3">
              <label for="validationCustom01">{{trans('table.namee')}}:</label>
              <input type="text" class="form-control name_en" value="" placeholder="Enter steering Name" name="name_en" required="" title="{{trans('table_man.steering_msg_name_en')}}">
            </div>
            <div class="col-md-12 mb-3">
              <label for="validationCustom01">{{trans('table.description')}}:</label>
              <input type="text" class="form-control desc" value="" placeholder="Enter Description" name="description" required="" title="{{trans('table_man.msg_desc')}}">
            </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <form action="" method="POST" id="editform" name="editform">
        ...
        <div class="modal-header">
          <div class="col-md-11 text-center">
            <h3 class="text-center">{{trans('table.steering1')}}</h3>
          </div>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        ...
        <div class="modal-body">
          <div class="form-row">
            <div class="col-md-12 mb-3">
              <label for="validationCustom01">{{trans('table.namel')}}:</label>
              <input type="text" class="form-control name" name="name" required="" value="" title="{{trans('table_man.steering_msg_name')}}">
            </div>
            <div class="col-md-12 mb-3">
              <label for="validationCustom01">{{trans('table.namee')}}:</label>
              <input type="text" class="form-control name_en" name="name_en" required="" title="{{trans('table_man.steering_msg_name_en')}}">
            </div>
            <div class="col-md-12 mb-3">
              <label for="validationCustom01">{{trans('table.description')}}:</label>
