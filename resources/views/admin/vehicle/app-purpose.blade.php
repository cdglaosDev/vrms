...
@section('app_purpose','active')
@section('content')
@include('vrms2.mod3-submenu')
<h3>
   {{trans('title.apppurpose')}}
      ...
      <tbody>
         ...
         <tr>
            ...
            <td class="sorting">
               ...
               data-backdrop="static" data-keyboard="false" data-act="Delete" 
               data-id="{{$data->id}}">
...
@component('component.admin.app-purpose')
@endcomponent
@include('delete')
@endsection
@push('page_scripts')
<script type="text/javascript">
   var base_url = "{{url('admin/app-purpose')}}";
   ...
   $('#add-form').click(function(e) {
      ...
      var form = $("#addform");
      insertAppPurpose(name, name_en, form, oldId);
   });
   ...
   function insertAppPurpose(name, name_en, form, oldId = null) {
      var url = "/get-app-purpose?name=" + name.val() + "&name_en=" + name_en.val() + "&id=" + oldId;
