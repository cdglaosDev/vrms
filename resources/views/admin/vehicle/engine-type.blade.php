...
@section('eng_type','active')
@section('content')
@include('vrms2.mod3-submenu')
<h3>
   {{trans('title.enginetype')}}
...
@component('component.admin.enginetype') @endcomponent
@include('delete')
@endsection
@push('page_scripts')
<script type="text/javascript">
   var base_url = "{{url('admin/engine-type')}}";
   ...
   $('#add-form').click(function(e) {
      ...
      var form = $("#addform");
      insertEngineType(name, name_en, desc, form, oldId);
   });
   ...
   function insertEngineType(name, name_en, desc, form, oldId = null) {
      var url = "/get-engine-type?name=" + name.val() + "&name_en=" + name_en.val() + "&id=" + oldId;
