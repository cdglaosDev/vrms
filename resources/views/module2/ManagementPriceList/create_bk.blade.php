              ...
              <table class="table  table-bordered" id="pList" style="table-layout:fixed;">
                ...
                @if(isset($price_item_unit))
                  @for($i =0;$i<count($price_item_unit);$i++)
                    <tr>
                      <td><input type="text" id="item-code-{{$i}}" class="border-0 item" name="item_code[]" value="{{ $price_item_unit[$i]->price_item['code'] ?? '' }}" readonly ></td>
                      <td>
...
<!-- start print page -->
<div id="print-paper" style="background-size: cover;background-position: left;background-repeat: no-repeat;width:1400px; height: 950px;">
<div  class="row">
      
    <div class="row" style="margin-top: 180px;height: 50px;padding-top:10px">
      <div class="col-md-4">
        <div id="printBill" style="text-align: right;margin-left:120px;"> <input type="text" class="form-control mb-1 mr-sm-1 border-0 font-weight-bold"   placeholder=""  name="print_price_receipt_no" value=""> </div>
        
      </div>
      <div class="col-md-3">
        <div id="printDate" style="margin-left: 100px;"> <input type="text" class="form-control border-0 font-weight-bold" id="issue_date" value="" name="date"></div>
      </div>
      <div class="col-md-3">
        <div id="printAppNo" style="text-align:right;margin-left:100px;"> <input type="text"  name="app_no" value=""  class="form-control border-0 font-weight-bold " style="font-family:'Saysettha OT' !important"> </div>
    
      </div>
      <div class="col-md-3">
        <div id="printAppDate" style="text-align:right;margin-left:110px;"> <input type="text" id="print_app_date"  name="ref_date" value=""  class="price-print-date form-control border-0 font-weight-bold "> </div>
        
      </div>
    </div>
    <div class="row" style="margin-left:290px; margin-top: 55px; width: 820px;">
      <div class="col-md-12">
    ...
    <div class="row" style="height:350px;margin:145px 20px 0px 10px;">
      <div id="printList">
      </div>
    </div>
    <div id="buy_lic_no" style="padding: 20px;margin-left: 150px;margin-top: -100px;color: #007bff;font-weight: 600;font-size:24px;width: 200px;font-family: Saysettha OT !important; font-family: Saysettha OT !important;"></div>
    
  <div class="row" style="margin-top: 130px;"> 
    <div style="width: 35%;padding-left: 180px;"><span style="font-size: 24px;font-family:'Saysettha OT' !important" class="updated_by"></span></div>
    <div style="width: 37%;">&nbsp;</div>
    <div style="width:20%;padding-right: initial;padding-bottom: 20px;"> <div id="printTotal"> <input type="text" class="form-control border-0" id="total_amt" name="total_amt" placeholder="" value="{{ $total_amt ?? ''}}" style="text-align: right;"> </div></div>
    <div  style="width:5%;font-size: 24px;padding-top: 6px;">{{"ກີບ"}}</div>
    </div>
</div>
 <!-- end print page -->
...
<script>
  ...
  var assignCounter = <?php echo json_encode($assign_counter) ?>;
...
<script>
  ...
  $('#icode').keyup(function(event) {   
    ...
    var itemCode = [];
    $('#pList > tbody  > tr').each(function() {
      itemCode.push($(this).find('.item').val());
    });
