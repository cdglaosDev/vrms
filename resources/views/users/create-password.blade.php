...
<body>
    ...
    <div class="row justify-content-center">
        <div class="col-md-4">
            <div class="card" style="margin-top:100px">
                <h5 class="text-center" style="padding-top: 28px">{{ __('Create New Password') }}</h5>
                @include('flash')
                <div class="card-body">
                    <form id="login-form" name="login-form" class="nobottommargin" action="{{url('create-new-password',$data->id)}}" method="post">
        ...
        <div class="form-row">
           ...
           <input id="email" name="email" value="{{$data->email !=''?$data->email:''}}"  type="text" class="form-control input-lg"  readonly="">
            </div>
            <div class="col-md-12 mb-3">
            <label for="validationCustom01">UserID</label>
           <input id="email" name="email" value="{{$data->login_id !=''?$data->login_id:''}}"  type="text" class="form-control input-lg"  readonly="">
            </div>
            <div class="col-md-12 mb-3">
        ...
        <div class="form-actions">
            <div id="working"></div>
            <button class="btn btn-primary green uppercase btn-block" id="login-form-submit" >Submit</button>
        </div>
