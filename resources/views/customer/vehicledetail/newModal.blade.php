...
<div class="modal fade" id="newModal"   role="dialog"  aria-labelledby="transferModal" aria-hidden="true">
         ...
         <div class="modal-body pt-0">
            <div class="tab-content clearfix">
               ...
               <div class="col-md-3" style="float:right">
                  ...
                  <a href="{{url('/customer/vehicle-detail')}}" class="btn btn-secondary btn-sm mt-1">{{ trans('button.cancel')}}</a>
               </div>
               </form>
               </div>
               ...
               <div class="tab-pane" id="tenant1">
                  ...
                  <input type="hidden" name="vehicle_detail_id" class="vehicle_id" value="414">
...
<script type="text/javascript">
    ...
    var addImport = "{{url('/customer/vehicle-detail')}}";
    var addDoc = "{{ url('/customer/add-attach-document')}}";
    var addTenant = "{{ url('/customer/detail-tenant') }}";
