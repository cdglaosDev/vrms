...
@section('content') 
    ...
    <h1 class="page-header">{{trans('title.app_item_create1')}}</h1>
  ...
  @if ($errors->any())
    ...
    <div class="panel-body">
       <form  action="{{route('importdetail.store')}}"  method="POST">
                  @method('post')
                      @csrf
              <div class="form-row">
              ...
              <div class="col-md-4 col-sm-4 mb-3">
                ...
                <input type="number" class="form-control" id="validationCustom01" value="" placeholder="Enter Vehicle Number" name="car_number" required="">
              </div>
             ...
             <a class="btn  btn-default" href="{{route('importdetail.index')}}">{{trans('button.cancel')}}</a>
