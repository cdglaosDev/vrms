...
<div class="modal-body pt-0">
   <div class="tab-content clearfix">
               ...
               <tbody>
                  <tr>
                     <td style="padding-right:0px; width: 334px;">
                        ...
                        <input class="w120 license_no" id="edit-license" title="{{ trans('title.enter_license') }}" title="{{ trans('title.enter_license') }}" style="vertical-align:top;text-align:center;color:#f00;font-weight:bold;font-size:18px !important" name="licence_no_need"  f="222" value="{{ $vehicle->licence_no_need}}" required><br>
                        ...
                        <input name="owner_name" id="owner_name" title="{{ trans('title.enter_owner') }}" class="w180" f="222" value="{{ $vehicle->owner_name}}"><br>
                        <div>
                        ...
                        <b>{{ trans('common.province') }}:</b>
                           <select name="province_code" id="edit-province" title="{{ trans('title.select_province') }}" class="js-example-basic-single  w120" required>
                        ...
                        <select name="district_code" class="w120 js-example-basic-single" id="edit-district" title="{{ trans('title.select_district') }}" required>
                        ...
                        <select class="w120 js-example-basic-single customer_vehicletype" name="vehicle_type_id" title="{{ trans('title.select_vtype') }}" id="customer_vehicletype">
                     ...
                     <td style="padding-right:0px; width: 276px;">
                        ...
                        <input class="w120 cc num-dash-validate" type="text" min="0" name="cc" title="{{ trans('title.enter_cc') }}"  f="222" value="{{$vehicle->cc ?? ''}}"><br>
                        ...
                        <select class="w120 js-example-basic-single" title="{{ trans('title.select_brand') }}" name="brand_id" id="edit-vbrand"  required>
                        ...
                        <input style="width:169px;font-size:16px !important;font-family:dev_font !important" name="chassis_no" title1="{{ trans('title.exist_chassis') }}" title="{{ trans('title.enter_chassis') }}" class="eng-validate chassis_no" value="{{$vehicle->chassis_no}}" required><br>
                        ...
                        <input type="number" min="1" id="seat"  class="w120" step="any" name="seat" f="222" value="{{ $vehicle->seat }}">
                        ...
                        <input class="w120 weight num-dash-validate" type="text"  min="0" name="weight" f="222" title="{{ trans('title.enter_weight') }}" value="{{ $vehicle->weight }}"><br>
                        ...
                        <input class="w20 axis" name="axis" f="222" step="any" type="number" min="0"  value="{{ $vehicle->axis }}">
                        <b class="w60" style="width: 60px !important">{{ trans('module4.wheel') }}:</b> 
                        <input class="w20 wheels" name="wheels" f="222" value="{{ $vehicle->wheels }}" id="wheel"> <span id="err2" style="display:none; color:red;font-size: 12px;">This input value is not less than 1.</span><br>
                        <b>{{ trans('module4.year_mnf') }}:</b> 
                        <input  class="w120 date-year" type="number" step="any"  name="year_manufacture" id="year_manufacture"   value="{{ $vehicle->year_manufacture }}" f="222"><br>
                     ...
                     <td style="padding-right:0px;  width: 234px;">
                        ...
                        <b><!--ລົງວັນທີ່:-->{{ trans('module4.veh_mod4_date') }}:</b> <input class="w120 import_permit_date custom_date_vehicle" name="import_permit_date" maxlength="10" value="{{ $vehicle->import_permit_date }}" f="222"><br>
                        <span class="cDB">2.{{ trans('module4.indus_doc') }}:</span><br>
                        <b><!--ເລກທີ່:-->{{ trans('module4.veh_mod4_no') }}:</b> <input class="w120 industrial_doc_no" name="industrial_doc_no" f="222" value="{{ $vehicle->industrial_doc_no }}"><br>
                        <b><!--ເລກທີ່:-->{{ trans('module4.veh_mod4_date') }}:</b> <input class="w120 industrial_doc_date custom_date_vehicle" name="industrial_doc_date" maxlength="10" f="222" value="{{ $vehicle->industrial_doc_date }}"><br>
                        ...
                        <b><!--ລົງວັນທີ່:-->{{ trans('module4.veh_mod4_date') }}:</b> <input class="w120 technical_doc_date custom_date_vehicle" name="technical_doc_date" maxlength="10" f="222" value="{{ $vehicle->technical_doc_date }}"><br>
                        ...
                        <b>{{ trans('module4.veh_mod4_date') }}:</b><input class="w120 comerce_permit_date custom_date_vehicle" name="comerce_permit_date" maxlength="10" value="{{$vehicle->comerce_permit_date}}" f="222"><br>
      </div>
      </td>
      ...
      <b><!--ເລກທີ່:-->{{ trans('module4.veh_mod4_no') }}:</b> <input class="w120 tax_no" name="tax_no" title="{{ trans('title.enter_tax_no') }}" f="222" value="{{$vehicle->tax_no}}"><br>
      <b><!--ເລກທີ່:-->{{ trans('module4.veh_mod4_date') }}:</b> <input class="w120 tax_date custom_date_vehicle" name="tax_date" title="{{ trans('title.enter_tax_date') }}" maxlength="10" value="{{$vehicle->tax_date}}"><br>
      ...
      <b><!--ເລກທີ່:-->{{ trans('module4.veh_mod4_no') }}:</b> <input class="w120 tax_payment_no " name="tax_payment_no" title="{{ trans('title.enter_tax_payment_no') }}" f="222" value="{{ $vehicle->tax_payment_no }}"><br>
      <b><!--ເລກທີ່:-->{{ trans('module4.veh_mod4_date') }}:</b> <input class="w120 tax_payment_date custom_date_vehicle" name="tax_payment_date" title="{{ trans('title.enter_tax_payment_date') }}" maxlength="10"  value="{{$vehicle->tax_payment_date}}" ><br>
      <span class="cDB">7. {{trans('module4.police_doc') }}:</span><br>
      <b><!--ເລກທີ່:-->{{ trans('module4.veh_mod4_no') }}:</b> <input class="w120 police_doc_no" name="police_doc_no" f="222" value="{{ $vehicle->police_doc_no }}"><br>
      <b><!--ເລກທີ່:-->{{ trans('module4.veh_mod4_date') }}:</b> <input class="w120 police_doc_date custom_date_vehicle" name="police_doc_date"  value="{{ $vehicle->police_doc_date }}" maxlength="10"><br>
      ...
      @can('Importer-Application-Item-Approve')
         <a class="btn btn-success btn-sm approve @if($vehicle->regapps['app_status_id'] == 4  || $vehicle->regapps['app_status_id'] == 5|| $vehicle->regapps['app_status_id'] ==6) disabled @endif" data-id="{{ $vehicle->regapps['id']}}">{{ trans('button.approve') }}</a>
         <a href="" class=" {{$vehicle->regapps['app_status_id'] ==4 ||$vehicle->regapps['app_status_id'] ==5 || $vehicle->regapps['app_status_id'] ==6 ?'btn btn-secondary btn-sm  disabled':'btn btn-danger btn-sm reject'}}"   data-toggle="modal" data-target="#RejectModel" data-app_status_id = "{{$vehicle->regapps['app_status_id']}}" data-id="{{$vehicle->regapps['id']}}">{{ trans('button.reject') }}</a>
      @endcan
   ...
   <div class="tab-pane" id="docEdit">
      <form id="editForm" class="form-inline"  action="{{url('attach-document',  $vehicle->id)}}" method="post" enctype="multipart/form-data" onsubmit="return validateEdit()">
         @csrf
...
<script type="text/javascript">
   ...
   var editImport = "{{url('import-vehicle')}}";
   $('.js-example-basic-single').select2();

   $(document).on("click", '.reject', function (e) { 
      $("#editModal").css('opacity',"0.9");
         document.getElementById("reject_form").action = reject_url+"/"+$(this).data('id');
   });
     
   //update document file modal
